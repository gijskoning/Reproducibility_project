...
class CNNBase(NNBase):
    def __init__(self, num_inputs, recurrent=False, hidden_sizes=(512,)):
        super(CNNBase, self).__init__(recurrent, hidden_sizes[0], hidden_sizes[0])
        ...
        self.main = nn.Sequential(
            ...
            init_(nn.Linear(32 * 7 * 7, hidden_sizes[0])), nn.ReLU())

        init_ = lambda m: init(m, nn.init.orthogonal_, lambda x: nn.init.
                               constant_(x, 0))

        self.critic_linear = init_(nn.Linear(hidden_sizes[0], 1))
